...
public class StanfordCoreNlpDemo3 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (sentences != null && ! sentences.isEmpty()) {
      ...
      System.out.println("**************************************************");
      Map<Integer, CorefChain> corefChains1 = annotation.get(CorefCoreAnnotations.CorefChainAnnotation.class);
      if (corefChains1 != null)
      {
